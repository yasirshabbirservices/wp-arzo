  ...
  define(
    ...
    function (e, u, t) {
      ...
      function r(e, t, i) {
        ...
        if (
          (i in l.MODIFIER_KEYS && (i = -1), !s && 13 === i) &&
        ...
        return (
          !!(s || i in l.FUNCTION_KEYS || i in l.PRINTABLE_KEYS) && e(t, s, i)
        );
      }
      function a() {
  ...
  define(
    ...
    function (e, t, i) {
      ...
      ((t.TextInput = function (e, d) {
        function i() {
          ((t = !0), g.blur(), g.focus(), (t = !1));
        }
        function l() {
          (clearTimeout(T),
            (T = setTimeout(function () {
              (c && ((g.style.cssText = c), (c = "")),
        ...
        (D.addListener(
          ...
          D.addListener(
            ...
            function (e) {
              if (!t) {
                ...
                (d.onFocus(e), B.isEdge ? setTimeout(y) : y());
              }
            },
            d,
          ),
          ...
          (this.focus = function () {
            if (c || U || "browser" == this.$focusScroll)
              return g.focus({ preventScroll: !0 });
            var e = g.style.top;
          ...
          d.on("beforeEndOperation", function () {
            var e,
              t = d.curOp,
              i = t && t.command && t.command.name;
            "insertstring" != i &&
              ((e = i && (t.docChanged || t.selectionChanged)),
              h && e && ((w = g.value = ""), R()),
              y());
          }));
        var y = j
          ...
          : function () {
              if (!h && !m && (u || k)) {
                ...
                var e,
                  ...
                  a = "";
                d.session &&
                  ((t = (e = d.selection).getRange()),
                  (i = e.cursor.row),
                  (o = t.start.column),
                  (r = t.end.column),
                  (a = d.session.getLine(i)),
                  t.start.row != i
                    ? ((n = d.session.getLine(i - 1)),
                      (o = t.start.row < i - 1 ? 0 : o),
                      (r += n.length + 1),
                      (a = n + "\n" + a))
                    : t.end.row != i
                      ? ((s = d.session.getLine(i + 1)),
                ...
                var l = a + "\n\n";
                if (
                  (l != w && ((g.value = w = l), (v = $ = l.length)),
                  k && ((v = g.selectionStart), ($ = g.selectionEnd)),
                  $ != r || v != o || g.selectionEnd != $)
                )
                  try {
                    (g.setSelectionRange(o, r), (v = o), ($ = r));
                  } catch (e) {}
                h = !1;
              }
            };
        ((this.resetSelection = y), u && d.onFocus());
        var n = null;
        this.setInputHandler = function (e) {
          n = e;
        };
        function s(e, t) {
          if (((k = k && !1), f)) return (y(), e && d.onPaste(e), (f = !1), "");
          for (
        ...
        (D.addCommandKeyListener(g, d.onCommandKey.bind(d), d),
          D.addListener(
            ...
            function (e) {
              ...
              h ||
                (r
                  ? (r = !1)
                  : 0 === (t = g).selectionStart &&
                      t.selectionEnd >= w.length &&
                      t.value === w &&
                      w &&
                      t.selectionEnd !== $
                    ? (d.selectAll(), y())
                    : Y && g.selectionStart != v && y());
            },
            d,
          ),
          ...
          ("oncut" in g && "oncopy" in g && "onpaste" in g) ||
            D.addListener(
              e,
              "keydown",
              function (e) {
        ...
        var L = function () {
          ...
          R = function (e) {
            d.onCompositionEnd &&
              !d.$readOnly &&
              ((h = !1), d.onCompositionEnd(), d.off("mousedown", i), e && o());
          },
        ...
        (D.addListener(
          ...
          function (e) {
            ...
            h ||
              ...
              p ||
                ...
                h.useTextareaForIME
                  ? ((w = g.value = ""), ($ = v = 0))
                  : (g.msGetInputContext && (h.context = g.msGetInputContext()),
          ...
          D.addListener(
            ...
            function (e) {
              (27 == e.keyCode &&
                g.value.length < g.selectionStart &&
                (h || (w = g.value), (v = $ = -1), y()),
                M());
            },
            d,
          ...
          (this.onContextMenu = function (e) {
            ((k = !0),
              y(),
              d._emit("nativecontextmenu", { target: d, domEvent: e }),
          ...
          (this.moveToMouse = function (e, t) {
            ((c = c || g.style.cssText),
              (g.style.cssText =
                ...
                (B.isIE ? "opacity:0.1;" : "") +
                "text-indent: -" +
                (v + $) * d.renderer.characterWidth * 0.5 +
                "px;"));
            function i(e) {
              ...
              ((i =
                -1 == (e = this.$clickSelection.comparePoint(s))
                  ...
                  : 1 == e
                    ...
                    : ((s = (t = l(this.$clickSelection, s)).cursor),
                      t.anchor)),
      ...
      function n(t) {
          ...
          ((u = g.renderer.screenToTextCoordinates(f, m)),
            ...
            !v || n || s
              ...
              : 5 < S($.x, $.y, f, m)
                ? (v = null)
                : 200 <= i - v &&
                  (g.renderer.scrollCursorIntoView(), (v = null)),
            (function (e, t) {
              var i = Date.now(),
        ...
        ((this.onDragStart = function (e) {
          ...
          ((i.effectAllowed = g.getReadOnly() ? "copy" : "copyMove"),
            A.isOpera && (g.container.appendChild(a), (a.scrollTop = 0)),
          ...
          (this.onDragLeave = function (e) {
            if (--y <= 0 && l) return (n(), (d = null), k.preventDefault(e));
          }),
      ...
      t.addTouchListeners = function (e, $) {
        ...
        function i() {
          ...
          ((a.style.top = t.pageY - s.top - 3 + "px"),
            t.pageX - s.left < s.width - 70
              ? ((a.style.left = ""), (a.style.right = "10px"))
              : ((a.style.right = ""), (a.style.left = i + n - s.left + "px")),
            (a.style.display = ""),
            (a.firstChild.style.display = "none"),
            $.on("input", r));
        }
        function r(e) {
          (a && (a.style.display = "none"), $.off("input", r));
        }
        function b() {
          ...
          ((!e.isEmpty() && t) ||
            ($.selection.moveToPosition(A), $.selection.selectWord()),
            (R = "wait"),
            i());
        }
        var y,
              ...
              if (
                ...
                (E++,
                  ...
                  (function () {
                    ...
                    var e =
                      2 <= E
                        ? $.selection.getLineRange(A.row)
                        : $.session.getBracketRange(A);
                    (e && !e.isEmpty()
                      ? $.selection.setRange(e)
                ...
                if (e.clientX < g.left) return void (R = "zoom");
                var w = p(
                    e.clientX - g.left - u.left + m,
                    e.clientY - g.top - u.top + f,
                  ),
                  v = p(
                    e.clientX - g.left - d.left + m,
                    e.clientY - g.top - d.top + f,
                  );
            ...
            function (e) {
              ((L = $.$mouseHandler.isMousePressed = !1),
                ...
                "zoom" == R
                  ? ((R = ""), (M = 0))
                  : k
                    ? ($.selection.moveToPosition(A), (M = 0), i())
                    : "scroll" == R
                      ? ((M += 60),
                        (t = setInterval(function () {
                          (M-- <= 0 && (clearInterval(t), (t = null)),
                            Math.abs(T) < 0.01 && (T = 0),
                            Math.abs(_) < 0.01 && (_ = 0),
                            M < 20 && (T *= 0.9),
                            M < 20 && (_ *= 0.9));
                ...
                ((x = a),
                  "scroll" == R
                    ? (((o = new F(e, $)).speed = 1),
                      ...
                      0 != l && ((T = n / l), (_ = s / l)),
                      $._emit("mousewheel", o),
                      o.propagationStopped || (T = _ = 0))
                    : ((r = new F(e, $).getDocumentPosition()),
                      "cursor" == R
                        ? $.selection.moveCursorToPosition(r)
                        : "anchor" == R &&
                          $.selection.setSelectionAnchor(r.row, r.column),
      ...
      function m(e, t, i, n) {
        ...
        switch (a) {
          ...
          case T:
            ...
            if ($) return x;
            for (r = n + 1, o = t.length; r < o && t[r] == T; ) r++;
            return r < o && t[r] == g ? g : x;
          case _:
            for (o = t.length, r = n + 1; r < o && t[r] == _; ) r++;
            if (r < o) {
              var l = e[n],
                h = (1425 <= l && l <= 2303) || 64286 == l,
                c = t[r];
              if (h && (c == d || c == L)) return d;
            }
            ...
            (function (e, t, i, n) {
              ...
              if (y)
                for (u = 0; u < i; u++)
                  if (n[u] == A) {
                    t[u] = w;
                    for (var f = u - 1; 0 <= f && n[f] == R; f--) t[f] = w;
                  }
            })(n, r, n.length, t));
      ...
      ((function () {
        (s.implement(this, o),
            ...
            (e = this.session.getFoldAt(i.row, i.column, -1))
              ...
              : 0 === i.column
                ? 0 < i.row &&
                  this.moveCursorTo(
                    i.row - 1,
                    this.doc.getLine(i.row - 1).length,
                  )
          ...
          (this.moveCursorBy = function (e, t) {
            ...
            (0 === t &&
              (0 !== e &&
                (this.session.$bidiHandler.isBidiRow(s.row, this.lead.row)
                  ? ((i = this.session.$bidiHandler.getPosLeft(s.column)),
                    (s.column = Math.round(
                      i / this.session.$bidiHandler.charWidths[0],
                    )))
                  : (i = s.column * this.session.$bidiHandler.charWidths[0])),
              this.$desiredColumn
                ? (s.column = this.$desiredColumn)
                : (this.$desiredColumn = s.column)),
              0 != e &&
                this.session.lineWidgets &&
                this.session.lineWidgets[this.lead.row] &&
                ((n = this.session.lineWidgets[this.lead.row]),
                e < 0
                  ? (e -= n.rowsAbove || 0)
                  : 0 < e && (e += n.rowCount - (n.rowsAbove || 0))));
        ...
        p = function (g) {
          (this.add("braces", "insertion", function (e, t, i, n, s) {
            ...
            if ("{" == s) {
              ...
              if ((C(i), "}" == r.substring(o.column, o.column + 1)))
                if (
                  null !==
              ...
              if (1 == s.length && o[s]) {
                ...
                if (!l) {
                  ...
                  if (d == r)
                    ...
                    var y = c[h.column - 2];
                    if (u == r && (y == r || v.test(y))) return null;
                    m = !0;
                  }
              ...
              : i.range.isEnd(e.end.row, e.end.column)
                ...
                : i.range.isStart(e.start.row, e.start.column)
                  ...
                  : e.sameRow
                    ...
                    : ((r = (t = i.split(e.start.row, e.start.column))
                        .folds).shift(),
            ...
            (this.$onChangeMode = function (e, t) {
              ...
              (t || (this.$modeId = e.$id),
                this.$mode !== e &&
                  ...
                  void 0 !== (n = e.getTokenizer()).on &&
                    ((s = this.onReloadTokenizer.bind(this)),
                    n.on("update", s)),
                  this.bgTokenizer
              ...
              this.$highlightPending ||
                ...
                setTimeout(function () {
                  ...
                  i &&
                    i.bgTokenizer &&
                    (i.$bracketHighlight &&
                      (i.$bracketHighlight.markerIds.forEach(function (e) {
                        i.removeMarker(e);
                      }),
                      (i.$bracketHighlight = null)),
                    !(e = i.getMatchingBracketRanges(n.getCursorPosition())) &&
                      i.$mode.getMatching &&
                      (e = i.$mode.getMatching(n.session)),
                    e &&
                      ((t = "ace_bracket"),
                      Array.isArray(e)
                        ? 1 == e.length && (t = "ace_error_bracket")
                        : (e = [e]),
                      2 == e.length &&
                        (0 == w.comparePoints(e[0].end, e[1].start)
                          ? (e = [w.fromPoints(e[0].start, e[1].end)])
                          : 0 == w.comparePoints(e[0].start, e[1].end) &&
                            (e = [w.fromPoints(e[1].start, e[0].end)])),
                      (i.$bracketHighlight = {
                        ranges: e,
                        ...
                        do {
                          if (((n = a), (a = i.stepBackward()), n))
                            if (-1 !== n.type.indexOf("tag-name"))
                              ...
                              for (var c = 0; c < l; c++) i.stepForward();
                            }
                        } while (a && r <= 0);
                        i.stepForward();
                      }
            ...
            (this.$updateHighlightActiveLine = function () {
              ...
              (this.$highlightActiveLine &&
                ...
                i.$highlightLineMarker && !e
                  ...
                  : !i.$highlightLineMarker && e
                    ? (((t = new w(e.row, e.column, e.row, 1 / 0)).id =
            ...
            (this.autoIndent = function () {
              ...
              for (
                ...
                (0 < d &&
                  ...
                  c !== (r = s.$getIndent(o)) &&
                    (0 < r.length &&
                      ((a = new w(d, 0, d, r.length)), n.remove(a)),
                    0 < c.length && n.insert({ row: d, column: 0 }, c)),
                  s.autoOutdent(l, n, d));
            }),
            ...
            set: function (e) {
              (this.$updatePlaceholder ||
                ((this.$updatePlaceholder = function () {
                  ...
                  t && this.renderer.placeholderNode
                    ? (this.renderer.off(
                        "afterRender",
                        this.$updatePlaceholder,
                      ),
                    ...
                    : t || this.renderer.placeholderNode
                      ...
                      : (this.renderer.on(
                        ...
                        ((e = n.createElement("div")).className =
                          "ace_placeholder"),
    ...
    function (e, t, i) {
      ...
      function l(e, t) {
        var i,
          ...
          s = "insert" == e.action,
          o = "insert" == t.action;
        if (s && o) m(e.start, t.start) < 0 ? h(t, e, 1) : h(e, t, 1);
        else if (s && !o)
          0 <= m(e.start, t.end)
            ? h(e, t, -1)
            : (m(e.start, t.start) <= 0 ||
          ...
          if (0 <= m(t.start, e.end)) h(t, e, -1);
            ...
            if (!(m(t.end, e.start) <= 0))
              return (
                m(e.start, t.start) < 0 && (e = u((i = e), t.start)),
            ...
            function () {
              ...
              this.displayIndentGuides &&
                ...
                (i = this.showSpaces
                  ...
                  : ""),
                (n = this.showSpaces
                  ? v.stringRepeat(this.SPACE_CHAR, this.tabSize)
                  : v.stringRepeat(" ", this.tabSize)),
                (s = this.showTabs ? " ace_invisible ace_invisible_tab" : ""),
                (o = this.showTabs
                  ? v.stringRepeat(this.TAB_CHAR, this.tabSize)
                  : n),
        ...
        ((this.CHANGE_CURSOR = 1),
          ...
          (this.$updatePrintMargin = function () {
            ...
            (this.$showPrintMargin || this.$printMarginEl) &&
              (this.$printMarginEl ||
                (((e = c.createElement("div")).className =
          ...
          (this.$moveTextAreaToCursor = function () {
            ...
            this.$isMousePressed ||
              ...
              (t = this.$composition),
              this.$keepTextAreaAtCursor || t
                ? (i = this.$cursorLayer.$pixelPos) &&
                  (t &&
                    t.markerRange &&
                    ...
                    : ((h = 1),
                      ...
                      t
                        ? t.useTextareaForIME
                          ...
                          : (s += this.lineHeight + 2)
                        : (s += this.lineHeight),
                      (o -= this.scrollLeft) > this.$size.scrollerWidth - h &&
                        (o = this.$size.scrollerWidth - h),
                      (o += this.gutterWidth + this.margin.left),
                      c.setStyle(e, "height", r + "px"),
                      c.setStyle(e, "width", h + "px"),
                      c.translate(
                        this.textarea,
                        Math.min(o, this.$size.scrollerWidth - h),
                        Math.min(s, a),
                      )))
            ...
            return (
              ...
              (this.layerConfig = {
                ...
                gutterOffset: v
                  ? Math.max(
                      0,
                      Math.ceil((m + t.height - t.scrollerHeight) / v),
                    )
                  : 0,
        ...
        if (
          ...
          if (0 === r) {
            var a,
              ...
              g = c.getCursor(),
              f = e.inSelection() || (c.isEmpty() && A(d, g)),
              m = e.x,
              p = e.y,
              w = h.session,
            ...
            if (
              ...
              ((h.inVirtualSelectionMode = !0),
                ...
                h.once("mouseup", function () {
                  ...
                  (b && e.isEmpty() && A(b.cursor, e.cursor)
