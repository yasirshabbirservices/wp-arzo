...
<div class="content">
    ...
    <div style="background: #2A2A2A; padding: 20px; border-radius: 3px; border: 1px solid #333333;">
        ...
        <p><strong>Bypass URL:</strong> <a href="<?php echo home_url('?maintenance_bypass=' . wp_create_nonce('maintenance_bypass')); ?>"
                target="_blank"
                style="color: var(--accent-color);"><?php echo home_url('?maintenance_bypass=' . wp_create_nonce('maintenance_bypass')); ?></a></p>
