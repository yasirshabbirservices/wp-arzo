...
function wp_arzo_pro_feature_catalog()
{
    return array(
        ...
        array('id' => 'cron_manager', 'title' => 'Advanced Cron Manager', 'group' => 'ops', 'icon' => 'clock', 'description' => 'Full WP-Cron control center: create, edit, run, pause and delete events; scheduled URL jobs (webhooks, cache warmers); custom intervals; a timed run log; and cron health diagnostics with a spawn test.'),
        ...
        array('id' => 'site_health', 'title' => 'Site Health Monitor', 'group' => 'ops', 'icon' => 'heartbeat', 'description' => 'Automated checks for disk space, SSL-certificate expiry, pending updates, PHP version EOL, WP-Cron, loopback reachability and response time — with alerts to your Notifications channels, an outbound heartbeat ping (Healthchecks.io-style dead-man switch), and a token-guarded status endpoint for external uptime monitors.'),
