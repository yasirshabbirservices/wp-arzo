...
function wp_arzo_pro_feature_catalog()
{
    return array(
        ...
        // Media
        array('id' => 'media_folders', 'title' => 'Media Folders', 'group' => 'media', 'icon' => 'image', 'description' => 'Organise the media library into nestable folders, with library filters and per-file assignment.'),
