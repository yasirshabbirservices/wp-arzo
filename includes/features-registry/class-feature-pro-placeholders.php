...
function wp_arzo_pro_feature_catalog()
{
    return array(
        ...
        array('id' => 'site_health', 'title' => 'Site Health Monitor', 'group' => 'ops', 'icon' => 'heartbeat', 'description' => 'Automated checks for disk space, SSL-certificate expiry, pending core/plugin/theme updates, PHP version EOL, WP-Cron and loopback reachability — with alerts pushed to your Notifications channels on status changes.'),
